(function (global, factory) {
    ...
    let attestationOptions = "/web/authn/attestation/options";
    let attestationResult = "/web/authn/attestation/result";
    let assertionOptions = "/web/authn/assertion/options";
    let assertionResult = "/web/authn/assertion/result";
    ...
    class WebAuthnApp {
        ...
        register() {
            ...
            return this.requestRegisterOptions()
                ...
                .then((newCred) => {
                    this.sendRegisterResult(newCred); 
    ...
    exports.WebAuthnHelpers = helpers;
